  ...
  return (
    <div className=" flex flex-col gap-3">
      ...
      <div className=" flex justify-between items-center text-sm">
        <p className=" text-muted-foreground">지급일</p> <p className="">{payDate}</p>
      </div>
      <div className=" h-px bg-border" />
      <div className=" flex justify-between items-center">
        <p className="text-sm text-muted-foreground">월 급여</p> <h4>{data?.gross_pay}</h4>
      </div>
      <div className=" flex justify-between items-center">
        <p className="text-sm text-muted-foreground">공제계</p> <h4>{data?.total_deduction}</h4>
      </div>
    </div>
  );
};
